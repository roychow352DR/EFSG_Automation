Feature: AO Username
  ...
  Scenario: Cannot create account if username already in used in L2 account
    ...
    And the user fills value "QaAutoL2" in the text field "username" on application information page
