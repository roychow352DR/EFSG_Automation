Feature: AO Application List
  ...
  Scenario: User able to edit Default deposit/withdrawal currency in "Pending Verification" status after MT5 account is created by mobile app
    Given the user logged in to Admin Portal as username "qaauto" and password "Test1234@"
    And the user clicks the detail button for the application record with status "Pending Verification", created by "Customer", and client type "LEVEL_3_INDIVIDUAL" on the application list page
