Feature: AO Application List
  ...
  Scenario: The Default deposit withdrawal currency field is editable on Trading Experience page in Pending Verification status
    Given the user logged in to Admin Portal as username "qaauto" and password "Test1234@"
    And the user clicks the detail button for the application record with status "Pending Verification", created by "qaauto", and client type "LEVEL_3_INDIVIDUAL" on the application list page
