Feature: AO Application List
  ...
  Scenario: The Upper IB Acc is override after the user enters valid IB code
    ...
    Then the user sees text field "upperIBTradingAcct" displayed expected value as entity trade group info "upperIBTradingAcct" obtain from eCRM on the application information page
