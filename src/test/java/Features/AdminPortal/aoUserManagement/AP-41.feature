Feature: AO User Management
  ...
  @Regression @AdminPortal @UserManagement @EBL_MT5 @EIEHK @XPro
    Scenario: Admin Role can be updated successfully
      ...
      When the user clicks detail button of username "qaauto" on the user management page
      ...
      And the user clicks detail button of username "qaauto" on the user management page
