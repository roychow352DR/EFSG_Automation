Feature: Customer Management
  ...
  Scenario: Prompted error after the invalid promotion code is entered on CM
    ...
    When the user fills value "invalidPromo" in the text field "promoCode" on the CM personal information page
