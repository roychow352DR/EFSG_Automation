Feature: Native App trade
  ...
  Scenario: The status is displayed correctly on the limit pending order details page
    ...
    Then the user sees correct value "Status" on the pending order details page
