Feature: Native App AO Application
    ...
    Scenario: User can edit position successfully
      ...
      And the user edit price type "Stop Loss" of the position on the app trade view
      And the user edit price type "Take Profit" of the position on the app trade view
      And the user taps button "Edit Position" on the app trade view
