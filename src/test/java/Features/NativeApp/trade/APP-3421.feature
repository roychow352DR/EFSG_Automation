Feature: Native App trade
    ...
    Scenario: The status of the open position is displayed as open on the position details page
      ...
      Then the user sees correct value "Status" on the position details page
