Feature: Native App trade
  ...
  Scenario: The product code is displayed correctly on the limit pending order details page
    ...
    Then the user sees correct value "Product" on the pending order details page
