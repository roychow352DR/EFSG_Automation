Feature: Native App trade
    ...
    Scenario: User can modify stop loss price of the TPSL pending order
      ...
      And the user edit price type "Stop Loss" of the pending order on the modify order page
      ...
      Then the user sees the value "Stop Loss Price" is edited on the pending order details page
