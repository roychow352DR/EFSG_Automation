Feature: Native App trade
    ...
    Scenario: The take profit price decreased by 1 point on the edit position page after minus button is tapped
      ...
      Then the user sees the "Take Profit" price is decreased by 1 point on the edit position page
