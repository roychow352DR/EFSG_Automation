Feature: App Trade
  ...
  Scenario: The direction of sell stop pending order is displayed correctly on the portfolio pending orders tab
    Given the user launch the app
    And the user login as username "autol3" and password "Test1234@" on App login page
    And the user taps button "Markets" on the app footer
    And the user places a pending order with direction "SELL" and order type "Sell Stop" on the instrument details page
