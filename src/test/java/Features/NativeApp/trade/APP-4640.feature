Feature: Native App trade
    ...
    Scenario: The initial margin of HKGHKD is displayed correctly on the position details page if default initial margin equals to 0
      ...
      And the user creates a "BUY" position of symbol "HKGHKD" on the instrument details page
