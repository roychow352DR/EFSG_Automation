Feature: Native App trade
    ...
    Scenario: User can edit sell market position successfully upon take profit price is greater than market price minus BS point
      ...
      And the user fills in the text field "Take Profit" with direction "SELL" on the edit position page
