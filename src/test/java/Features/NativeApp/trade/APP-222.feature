Feature: Native App trade
    ...
    Scenario: User sees market Buy TPSL order Confirmation page info based on the input values in previous page
      Given the user launch the app
      And the user login as username "rc60" and password "Test1234@" on App login page
