Feature: Native App trade
  ...
  Scenario: The estimated margin of XAUUSD is displayed correctly at pending order details page if initial margin equals to 0
    ...
    And the user places a pending order with direction "BUY" and order type "Buy Stop" symbol "XAUUSD" on the instrument details page
