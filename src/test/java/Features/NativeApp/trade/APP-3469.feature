Feature: Native App trade
  ...
  Scenario: The order type is displayed correctly on the limit pending order details page
    ...
    Then the user sees correct value "Order Type" on the pending order details page
