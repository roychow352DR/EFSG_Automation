Feature: Native App trade
    ...
    Scenario: User sees Buy Limit order Confirmation page info based on the input values in previous page
      ...
      And the user selects stop limit order option "Buy Limit" on the instrument details page
      And the user selects validity option "Today" on the instrument details page
