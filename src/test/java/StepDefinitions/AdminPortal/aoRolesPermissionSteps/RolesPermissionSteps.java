...
public class RolesPermissionSteps extends BaseTest {
    ...
    public void the_user_sees_button_is_enabled_on_the_roles_and_permission_page(String buttonText) {
        page.waitForLoadState(LoadState.NETWORKIDLE);
        Assert.assertTrue(aopoManager.getAoRolesPermissionPage().getButtonsByText(buttonText));
    }
    ...
    public void the_user_sees_button_is_disabled_on_the_ao_roles_and_permission_page(String buttonText) {
        page.waitForLoadState(LoadState.NETWORKIDLE);
        Assert.assertFalse(aopoManager.getAoRolesPermissionPage().getButtonsByText(buttonText));
    }
    ...
    public void the_user_fills_value_into_the_text_field_on_the_role_and_permission_page(String inputVal, String textField) {
        aopoManager.getAoRolesPermissionPage().getTextFieldByName(textField).fill(inputVal);
    }

    @Then("the user sees an error dialogue with wordings {string} is prompted on the role and permission page")
    public void the_user_sees_an_error_dialogue_with_wordings_is_prompted_on_the_role_and_permission_page(String dialogueText) {
        Assert.assertEquals(aopoManager.getAoRolesPermissionPage().getAlert().textContent(), dialogueText);
    }
