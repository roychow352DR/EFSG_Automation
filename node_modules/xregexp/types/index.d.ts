...
declare namespace XRegExp {
    ...
    /**
     * Valid login that are installable on RegExp.
     */
    type Feature = 'astral' | 'namespacing';

    /**
     * All valid ways of specifying login to install or uninstall.
     */
    ...
    /**
     * Installs optional login according to the specified options. Can be undone using
     * `XRegExp.uninstall`.
     *
     ...
     *
     * Interpolation of strings and regexes shares the login of `XRegExp.build`. Interpolated
    ...
    /**
     * Uninstalls optional login according to the specified options. All optional login start out
